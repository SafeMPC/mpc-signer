...
const file_proto_mpc_v1_mpc_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x012\x99\x02\n" +
	"\aMPCNode\x12H\n" +
	"\x12JoinSigningSession\x12\x16.mpc.v1.SessionMessage\x1a\x16.mpc.v1.SessionMessage(\x010\x01\x12=\n" +
	"\bStartDKG\x12\x17.mpc.v1.StartDKGRequest\x1a\x18.mpc.v1.StartDKGResponse\x12C\n" +
...
var file_proto_mpc_v1_mpc_proto_goTypes = []any{
	...
	(*AggregateRequest)(nil),      // 8: mpc.v1.AggregateRequest
	(*AggregateResponse)(nil),     // 9: mpc.v1.AggregateResponse
	(*SessionMessage)(nil),        // 10: mpc.v1.SessionMessage
	(*JoinRequest)(nil),           // 11: mpc.v1.JoinRequest
	(*ShareMessage)(nil),          // 12: mpc.v1.ShareMessage
	(*SessionConfirmation)(nil),   // 13: mpc.v1.SessionConfirmation
	(*RoundMessage)(nil),          // 14: mpc.v1.RoundMessage
	(*CompletionMessage)(nil),     // 15: mpc.v1.CompletionMessage
	(*ErrorMessage)(nil),          // 16: mpc.v1.ErrorMessage
	(*HeartbeatRequest)(nil),      // 17: mpc.v1.HeartbeatRequest
	(*HeartbeatResponse)(nil),     // 18: mpc.v1.HeartbeatResponse
...
var file_proto_mpc_v1_mpc_proto_depIdxs = []int32{
	...
	13, // 3: mpc.v1.SessionMessage.confirmation:type_name -> mpc.v1.SessionConfirmation
	14, // 4: mpc.v1.SessionMessage.round_message:type_name -> mpc.v1.RoundMessage
	15, // 5: mpc.v1.SessionMessage.completion_message:type_name -> mpc.v1.CompletionMessage
	16, // 6: mpc.v1.SessionMessage.error_message:type_name -> mpc.v1.ErrorMessage
	19, // 7: mpc.v1.HeartbeatRequest.status_info:type_name -> mpc.v1.HeartbeatRequest.StatusInfoEntry
	20, // 8: mpc.v1.HeartbeatResponse.instructions:type_name -> mpc.v1.HeartbeatResponse.InstructionsEntry
	10, // 9: mpc.v1.MPCNode.JoinSigningSession:input_type -> mpc.v1.SessionMessage
	6,  // 10: mpc.v1.MPCNode.StartDKG:input_type -> mpc.v1.StartDKGRequest
	4,  // 11: mpc.v1.MPCNode.SubmitSignatureShare:input_type -> mpc.v1.ShareRequest
	17, // 12: mpc.v1.MPCNode.Heartbeat:input_type -> mpc.v1.HeartbeatRequest
	0,  // 13: mpc.v1.MPCCoordinator.CreateSigningSession:input_type -> mpc.v1.CreateSessionRequest
	2,  // 14: mpc.v1.MPCCoordinator.GetSessionStatus:input_type -> mpc.v1.SessionStatusRequest
	8,  // 15: mpc.v1.MPCCoordinator.AggregateSignatures:input_type -> mpc.v1.AggregateRequest
	10, // 16: mpc.v1.MPCNode.JoinSigningSession:output_type -> mpc.v1.SessionMessage
	7,  // 17: mpc.v1.MPCNode.StartDKG:output_type -> mpc.v1.StartDKGResponse
	5,  // 18: mpc.v1.MPCNode.SubmitSignatureShare:output_type -> mpc.v1.ShareResponse
	18, // 19: mpc.v1.MPCNode.Heartbeat:output_type -> mpc.v1.HeartbeatResponse
	1,  // 20: mpc.v1.MPCCoordinator.CreateSigningSession:output_type -> mpc.v1.CreateSessionResponse
	3,  // 21: mpc.v1.MPCCoordinator.GetSessionStatus:output_type -> mpc.v1.SessionStatusResponse
	9,  // 22: mpc.v1.MPCCoordinator.AggregateSignatures:output_type -> mpc.v1.AggregateResponse
